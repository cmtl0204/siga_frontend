...
@Component({
  selector: 'app-teacher-list-coevaluation',
  templateUrl: './teacher-list-coevaluation.component.html',
  styleUrls: ['./teacher-list-coevaluation.component.css']
})
export class TeacherListCoevaluationComponent implements OnInit {
...
this.router.navigate(['teacher-eval/coevaluation-coordinator-area', id])
  }
