...
@Component({
  selector: 'app-teacher-list-coordinador',
  templateUrl: './teacher-list-coordinador.component.html',
  styleUrls: ['./teacher-list-coordinador.component.css']
})
export class TeacherListCoordinadorComponent implements OnInit {
...
this.router.navigate(['teacher-eval/self-eval-coordinador', id])
  }
