...
@Component({
  selector: 'app-teacher-list-coordinator',
  templateUrl: './teacher-list-coordinator.component.html',
  styleUrls: ['./teacher-list-coordinator.component.css']
})
export class TeacherListCoordinatorComponent implements OnInit {
...
this.router.navigate(['teacher-eval/coevaluation-coordinator', id])
  }
