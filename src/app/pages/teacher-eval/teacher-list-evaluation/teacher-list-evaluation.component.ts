...
@Component({
  selector: 'app-teacher-list-evaluation',
  templateUrl: './teacher-list-evaluation.component.html',
  styleUrls: ['./teacher-list-evaluation.component.css']
})
export class TeacherListEvaluationComponent implements OnInit {
...
this.router.navigate(['teacher-eval/evaluation-teacher', id])
  }
